                ...
                <div class="card-body">
                  <form role="form" method="POST">
                    <div class="input-group input-group-outline mb-3">
                      ...
                      <input placeholder="Name" type="text" class="form-control" name="adminname" required>
                    </div>
                    <!-- <div class="input-group input-group-outline mb-3">
                    ...
                    <div class="input-group input-group-outline mb-3">
                       <input placeholder="Password" type="password" class="form-control " name="adminpassword" required>
                    </div>
